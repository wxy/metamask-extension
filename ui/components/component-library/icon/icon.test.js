...
describe('Icon', () => {
  it('should render correctly', () => {
    const { getByTestId, container } = render(
      <Icon name={TEST_ICON_NAMES.ADD_SQUARE_FILLED} data-testid="icon" />,
    );
  ...
  it('should render with different icons using mask-image and image urls', () => {
    const { getByTestId } = render(
      <>
        <Icon
          name={TEST_ICON_NAMES.ADD_SQUARE_FILLED}
          data-testid="icon-add-square-filled"
        />
        <Icon
          name={TEST_ICON_NAMES.BANK_FILLED}
          data-testid="icon-bank-filled"
        />
        <Icon
          name={TEST_ICON_NAMES.BOOKMARK_FILLED}
          data-testid="icon-bookmark-filled"
        />
        <Icon
          name={TEST_ICON_NAMES.CALCULATOR_FILLED}
