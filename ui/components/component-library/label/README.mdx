...
The `Label` is a component used to display text within a container.
...
The `children` of the label can be text or more react nodes.
...
```jsx
import { DISPLAY, ALIGN_ITEMS, SIZES, COLORS } from '../../../helpers/constants/design-system';
